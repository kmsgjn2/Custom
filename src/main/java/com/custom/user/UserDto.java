...
public class UserDto {
	...
	private String custom_user_reg_date;
	private String custom_user_mod_date;

	public int getCustom_user_idx() {
		return custom_user_idx;
	}

	public void setCustom_user_idx(int custom_user_idx) {
		this.custom_user_idx = custom_user_idx;
	}
	...
	public String getCustom_user_reg_date() {
		return custom_user_reg_date;
	}

	public void setCustom_user_reg_date(String custom_user_reg_date) {
		this.custom_user_reg_date = custom_user_reg_date;
	}

	public String getCustom_user_mod_date() {
		return custom_user_mod_date;
	}

	public void setCustom_user_mod_date(String custom_user_mod_date) {
